...
#ifndef LTSpiceSymbolLexerBASE_H_INCLUDED
#define LTSpiceSymbolLexerBASE_H_INCLUDED
...
private:
    ...
    size_t (LTSpiceSymbolLexerBase::*d_get)() = &LTSpiceSymbolLexerBase::getInput;
...
public:
    LTSpiceSymbolLexerBase(LTSpiceSymbolLexerBase const &other)             = delete;
    LTSpiceSymbolLexerBase &operator=(LTSpiceSymbolLexerBase const &rhs)    = delete;
...
protected:
    LTSpiceSymbolLexerBase(std::istream &in, std::ostream &out);
    LTSpiceSymbolLexerBase(std::string const &infilename, std::string const &outfilename);
    ~LTSpiceSymbolLexerBase();
...
inline LTSpiceSymbolLexerBase::~LTSpiceSymbolLexerBase()
{
    d_input.close();
}

template <typename ReturnType, typename ArgType>
inline ReturnType constexpr LTSpiceSymbolLexerBase::as(ArgType value)
{
    return static_cast<ReturnType>(value);
}

inline bool LTSpiceSymbolLexerBase::knownFinalState()
{
    return (d_atBOL && available(d_final.bol.rule)) ||
           available(d_final.std.rule);
}

inline bool constexpr LTSpiceSymbolLexerBase::available(size_t value)
{   
    return value != std::numeric_limits<size_t>::max();
}

inline LTSpiceSymbolLexerBase::StartCondition__ constexpr LTSpiceSymbolLexerBase::SC(int sc)
{
    return as<StartCondition__>(sc);
}

inline int constexpr LTSpiceSymbolLexerBase::SC(StartCondition__ sc)
{
    return as<int>(sc);
}

inline std::ostream &LTSpiceSymbolLexerBase::out()
{
    return *d_out;
}

inline void LTSpiceSymbolLexerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void LTSpiceSymbolLexerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline void LTSpiceSymbolLexerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void LTSpiceSymbolLexerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &LTSpiceSymbolLexerBase::matched() const
{
    return d_matched;
}

inline LTSpiceSymbolLexerBase::StartCondition__ LTSpiceSymbolLexerBase::startCondition() const
{
    return SC(d_startCondition);
}

inline std::string const &LTSpiceSymbolLexerBase::filename() const
{
    return d_filename;
}

inline void LTSpiceSymbolLexerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t LTSpiceSymbolLexerBase::length() const
{
    return d_matched.size();
}

inline void LTSpiceSymbolLexerBase::leave(int retValue) const
{
    throw as<Leave__>(retValue);
}

inline size_t LTSpiceSymbolLexerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void LTSpiceSymbolLexerBase::more()
{
    d_more = true;
}

inline void LTSpiceSymbolLexerBase::begin(StartCondition__ startCondition)
{
    // d_state is reset to 0 by reset__()
    d_dfaBase__ = s_dfaBase__[d_startCondition = SC(startCondition)];
}

inline size_t LTSpiceSymbolLexerBase::state__() const
{
    return d_state;
}

inline size_t LTSpiceSymbolLexerBase::get__()
{
    return (this->*d_get)();
}

inline size_t LTSpiceSymbolLexerBase::getInput()
{
    return d_input.get();
}

inline bool LTSpiceSymbolLexerBase::return__()
{
    return d_return;
}

inline void LTSpiceSymbolLexerBase::noReturn__()
{
    d_return = false;
}


#endif //  LTSpiceSymbolLexerBASE_H_INCLUDED
